...
def load_nwb(patient, data_dir=None):
    """
    Load NWB data for a given patient.

    Parameters:
        patient (str): The patient ID.
        data_dir (str, optional): Directory containing NWB files. Defaults to "/data".
...
def get_movie_edges(nwb_data, bin_length):
    ...
    """
    df_nwb = nwb_data.processing["machine_learning"].data_interfaces["movie_binning_info"].to_dataframe()
...
def get_binned_spikes_nwb(patient, units, bin_length, data_dir=None):
    """
    ...
    """
    # Load nwb data file
    nwb_data, nwb_file = load_nwb(patient, data_dir=data_dir)
...
def _get_movie_frames_for_bin_length(nwb_data, bin_length):
    ...
    """
    iface = nwb_data.processing["machine_learning"].data_interfaces["movie_binning_info"] # adapted
...
def get_annotation_labels_nwb(patient, label_name, bin_length, data_dir=None):
    """
...
def get_unit_ids_for_patient_nwb(patient, brain_regions=None, data_dir=None):
    # Load nwb data file
    nwb_data, nwb_file = load_nwb(patient, data_dir=data_dir)
