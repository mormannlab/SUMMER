...
class DHVDatasetLabels(Dataset):
    """
    ...
    def __init__(
        ...
        # Load binned spikes (same as DHVDataset)
        list_binned = []
        n_bins_ref = None
        for pid in self.patient_ids:
            units = get_unit_ids_for_patient_nwb(
...
class DHVDataModuleLabels(pl.LightningDataModule):
    """Lightning DataModule for DHV NWB data with frame-level annotation labels.
    Same split options as DHVDataModule (fraction or buffer/fold).
    """
